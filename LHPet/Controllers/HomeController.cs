...
Clientes cliente1 = new Clientes (01, "Arthur Ferreira" , "857.032.950-41", "arthur.antunes@sp.senai.br", 
"Madruga");

Clientes cliente2 = new Clientes(02, "William Henry", "039.618.250-09", "bill@microsoft.com", "Bug");

Clientes cliente3 = new Clientes(03, "Ada Lovelace", 
"800.777.920-50", "ada@ada.language.com", "Byron");

Clientes cliente4 = new Clientes(04, "Linus Torvalds", "933.622.400-03", "torvalds@osdl.org", 
"Pinguim");

Clientes cliente5 = new Clientes(05, "Grace Hopper", 
